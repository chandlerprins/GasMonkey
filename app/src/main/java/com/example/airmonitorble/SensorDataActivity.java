...
public class SensorDataActivity extends AppCompatActivity {
    ...
    private void sendAlert(double aqi) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "air_alert").setSmallIcon(android.R.drawable.ic_dialog_alert).setContentTitle("⚠️ Dangerous Air Quality!").setContentText("AQI reached " + aqi).setPriority(NotificationCompat.PRIORITY_HIGH);
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("air_alert", "Air Alerts", NotificationManager.IMPORTANCE_HIGH);
